        ...
        `textarea.form-control`,
        {
            ...
            $onrender: (element) => {
                ...
                if (props.editable !== false) {
                    ...
                    if (
                        ["text/javascript", "text/html", "text/css"].includes(
                            mode
                        )
                    ) {
                        editor.constructor.Vim.defineOperator(
                            "indentAuto",
                            (cm) => {
                                let code;
                                if (cm.options.mode === "text/html") {
                                    ...
                                    cm.options.mode === "text/javascript"
                                ) {
                    ...
                    if (
                        ["text/css", "text/html", "text/javascript"].includes(
                            mode
                        )
                    ) {
